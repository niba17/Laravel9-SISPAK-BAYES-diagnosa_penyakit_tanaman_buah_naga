    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
                    ...
                    <form action="/login" method="post" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                placeholder="Username anda" autocomplete="on" name="nama"
                                value="{{ old('nama') }}">
                            @error('nama')
            ...
            <div class="text-center text-muted mt-3">
                Belum memiliki akun?<br> <a href="/member-create" tabindex="-1">Buat Akun Member</a> | <a
                    href="/pakar_member-create" tabindex="-1">Buat Akun Pakar</a>
            </div>
        </div>
    </div>
    <!-- Libs JS -->
