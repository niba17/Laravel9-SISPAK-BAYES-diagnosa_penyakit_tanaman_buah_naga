                            ...
                            <tbody>
                                @foreach ($save_hipotesa_fix as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <span style="color:#4299E1;">{{ '(' . $item['kode'] . ') ' }}</span>
                                            {{ $item['nama'] }}
                                        </td>
                                        <td>{{ $item['probabilitas'] }}</td>
                                        <td>
                                            @if ($item['persentase_probabilitas'] > 0)
                                                {{ $item['persentase_probabilitas'] }} %
                                            @else
                                                <span class="text-danger">Persentase probabilitas belum dihitung!</span>
                                            @endif
                                        </td>
                                        <td style="max-width: 500px;">
                                            @if (isset($item['solusi']))
                                                {{-- @foreach ($item['solusi'] as $item2) --}}
                                                {{-- <ul> --}}
                                                {{-- <li> --}}
                                                {{ $item['solusi'] }}
                                                {{-- </li> --}}
