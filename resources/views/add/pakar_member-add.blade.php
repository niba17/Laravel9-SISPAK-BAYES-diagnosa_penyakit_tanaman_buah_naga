...
<body class="border-top-wide border-primary d-flex flex-column">
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            ...
            <form class="card card-md" action="/pakar_member-store" method="post" autocomplete="off">
                @csrf
                <div class="card-body">
                    <h2 class="card-title text-center mb-4">Buat Akun Pakar</h2>
                    <div class="mb-3">
